...
const payrollRepository = {
  ...
  addEmployee: (employee: unknown) => ipcRenderer.invoke("repo:employees:add", employee),
  updateEmployee: (employee: unknown) => ipcRenderer.invoke("repo:employees:update", employee),
  deleteEmployee: (id: number) => ipcRenderer.invoke("repo:employees:delete", id),
