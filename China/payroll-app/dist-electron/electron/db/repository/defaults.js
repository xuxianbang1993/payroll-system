import { asBoolean, asNumber, asPositiveInteger, asRecord, asString, normalizeEmployeeType, resolveCompanyFullName, } from "./normalize.js";
...
export function normalizeEmployees(value) {
    ...
    for (const item of value) {
        ...
        const requestedId = asPositiveInteger(record.id) ??
...
export function normalizeRepositorySettings(value) {
